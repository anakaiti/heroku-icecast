...
<icecast>
    <!-- location and admin are two arbitrary strings that are e.g. visible
         ...
         (server_version.xsl). -->
    <location>$CFG_LOCATION</location>
    <admin>$CFG_ADMIN</admin>
    ...
    <authentication>
        ...
        <relay-password>$CFG_RELAY_PASSWORD</relay-password>

        <!-- Admin logs in with the username given below -->
        <admin-user>$CFG_ADMIN_USER</admin-user>
        <admin-password>$CFG_ADMIN_PASSWORD</admin-password>
    </authentication>
